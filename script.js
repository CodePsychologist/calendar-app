    ...
    updateChart() {
        try {
            ...
            this.transactions.forEach(transaction => {
                ...
                // Check if transaction is in the last 6 months
                for (let i = 0; i < 6; i++) {
                    let monthIndex = currentMonth - i;
                    let year = currentYear;
                    ...
                    if (transactionMonth === monthIndex && transactionYear === year) {
                        if (transaction.type === 'income') {
                            incomeData[5 - i] += transaction.amount;
                        } else {
                            expenseData[5 - i] += transaction.amount;
                        }
                        break;
                    }
                }
            ...
            console.log('Chart updated with data:', { months, incomeData, expenseData });
